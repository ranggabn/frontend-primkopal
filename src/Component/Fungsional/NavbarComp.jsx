        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="mr-auto">
            ...
            <NavDropdown title="Profil" id="basic-nav-dropdown">
              ...
              <NavDropdown.Item href="/struktur">Struktur Organisasi</NavDropdown.Item>
          ...
          <Form inline>
            <Button variant="outline-light mr-3" href="/masuk">Masuk</Button>
            <Button variant="outline-light" href="/daftar">Daftar</Button>
          </Form>
        </Navbar.Collapse>
      </div>
    </Navbar>
